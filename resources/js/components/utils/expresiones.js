...
export const letterOrWord = helpers.regex('alpha', /^[a-zA-ZÀ-ÿ\u00f1\u00d1]*$/)
...
export const textOracion = helpers.regex('alpha', /^[a-zA-Z0-9À-ÿ\u00f1\u00d1\s]*$/)

export const decimal = helpers.regex('alpha', /^-?[0-9]+\.?[0-9]*$/)
