<template>
  <b-container fluid>
    ...
    <b-modal id="formCliente" :title="infoModal.title" size="lg" scrollable hide-footer>
      <form-cliente @click="$bvModal.hide('formCliente')" @store="store" @update="update" :dataForm="infoModal"></form-cliente>
    </b-modal>
  </b-container>
  ...
  export default {
    ...
    methods: {
        newElement(){
            ...
            this.infoModal.title = 'Nuevo cliente'
      ...
      info(item, index, button) {
        ...
        this.infoModal.title = 'Editar cliente'
