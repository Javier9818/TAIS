<template>
  <b-container fluid>
    ...
    <b-modal id="formProveedor" :title="infoModal.title" size="lg" scrollable hide-footer>
      <form-proveedor @click="$bvModal.hide('formProveedor')" @store="store" @update="update" :dataForm="infoModal"></form-proveedor>
    </b-modal>
  </b-container>
  ...
  export default {
    ...
    methods: {
        newElement(){
            ...
            this.infoModal.title = 'Nuevo Proveedor'
       ...
       update: function(data) {
           this.items.map( (item) => {
               if(item.id === data.id) {item.razon_social = data.razon_social; item.ruc = data.ruc; item.descripcion = data.descripcion};
           });
       },
      info(item, index, button) {
        ...
        this.infoModal.title = 'Editar proveedor'
